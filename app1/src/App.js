...
class App extends Component {
  ...
  deleteInfo = (id) =>{
    console.log(id);
    let deletedInfos = this.state.displayInfos.filter( info =>{
      return info.id !== id
    })
    console.log('After Deleting---', deletedInfos);
    this.setState({
      displayInfos: deletedInfos
    })
  }
  render() {
    ...
    */
    ...
    return (
      <div className="App">
        ...
        <p>Let's Begin</p>
        <StatelessDisplay displayInfos={this.state.displayInfos} deleteInfo={this.deleteInfo}/>
